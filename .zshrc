...
export PATH=/home/miyawaki_shumpei/.redis/bin:$PATH
export PATH="/usr/local/cuda-10.1/bin:$PATH"
export LD_LIBRARY_PATH="/usr/local/cuda-10.1/lib64:$LD_LIBRARY_PATH"
export PATH="$HOME/lib/duf:$PATH"
export PATH="/home/miyawaki_shumpei/.cargo/bin:$PATH"
...
export JAVA_HOME="$HOME/lib/jdk1.8.0_191"  # jdk
export PATH="$JAVA_HOME/bin:$PATH"
export PATH="/home/miyawaki_shumpei/sh:$PATH"
export PATH="/home/miyawaki_shumpei/.sbt/bin:$PATH"  # sbt
export PATH="/work02/miyawaki/local/bin/jumanpp-2.0.0-rc3/bin:$PATH"
export PATH="$PATH:/home/miyawaki_shumpei/.go/bin"
export PATH="$PATH:/home/miyawaki_shumpei/heroku/bin"
export PATH="$PATH:/home/miyawaki_shumpei/ngrok"
...
# -----------------------------
clear 
if [ -d /work01/miyawaki/exp/miya-fairseq-gec ] ; then
  #cd ~/wikipedia-qa/efficient_qa
  nvidia-smi
  #cd
fi
...
alias dpr="cd /work01/miyawaki/DPR"
alias cyber="cd /work01/miyawaki/cyber/data_analysis"
alias slud="cd /work01/miyawaki/slud2020"
alias dime="cd /work02/ntt_dpr/bs16_tk200/dim_emb/retriever"
...
alias gid="echo 9e02b775f4c33945a85393c0148fd4196e1e0ca3"
...
alias work01="cd /work01/miyawaki"
alias work02="cd /work02/miyawaki"
...
alias GIZA++="$HOME/giza++/giza-pp/GIZA++-v2/GIZA++"
alias plain2snt="$HOME/giza++/giza-pp/GIZA++-v2/plain2snt.out"
alias snt2cooc="$HOME/giza++/giza-pp/GIZA++-v2/snt2cooc.out"
...
if [ -f '/home/miyawaki_shumpei/google-cloud-sdk/path.zsh.inc' ]; then . '/home/miyawaki_shumpei/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/home/miyawaki_shumpei/google-cloud-sdk/completion.zsh.inc' ]; then . '/home/miyawaki_shumpei/google-cloud-sdk/completion.zsh.inc'; fi
